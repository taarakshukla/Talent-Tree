    ...
    const pay = async (amount) => {
        ...
        try {
            ...
            const options = {
                ...
                image: `${process.env.NEXT_PUBLIC_URL}/icons/logo.gif`,
                order_id: orderId,
            ...
            {loading ? (
                ...
                <>
                    ...
                    <div className='cover w-full relative'>
                        <img className="object-fill w-full h-48 md:h-[50vh] lg:h-[60vh] opacity-85" alt="" src={currentUser.coverPic} />
                    ...
                    <div className='info flex justify-center items-center mt-10 mb-10 md:mt-20 md:mb-24 flex-col'>
                        ...
                        <div className='text-slate-400'>Let's help {username} grow!! </div>
                    ...
                    <div className='flex items-center justify-around'>
                        <div className="payment flex justify-center gap-5 w-[95%] mb-11 flex-col md:flex-row">
                            <div className="supporters w-full md:w-1/2 bg-[#585858] rounded-lg text-white p-10">
                            ...
                            <div className="makePayment w-full md:w-1/2 bg-[#585858] rounded-lg text-white p-10">
